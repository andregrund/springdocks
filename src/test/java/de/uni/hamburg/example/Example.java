...
import de.uni.hamburg.frontend.LocalMicrophone;
import de.uni.hamburg.frontend.VoiceActivityDetector;
...
class Example {
    ...
    private static void testFile(String filename, String sentence, RawGoogleRecognizer rawGoogleRecognizer,
        ...
        printer.printColor(Colors.ANSI_CYAN, sentence, verbose);

...
public class LexTreeLinguistNoHMM implements Linguist {
    ...
    public LexTreeLinguistNoHMM(AcousticModel acousticModel, UnitManager unitManager, LanguageModel languageModel,
    ...
    public class LexTreeEndUnitState extends LexTreeState implements UnitSearchState {
        ...
        public SearchStateArc[] getSuccessors() {
            SearchStateArc[] arcs = getCachedArcs();
            if (arcs == null) {
                UnitNode[] nodes = getUnitNodes(getEndNode());
    ...
    public class LexTreeUnitState extends LexTreeState implements UnitSearchState {
         ...
         * @param wordSequence the history of words
         */
        LexTreeUnitState(UnitNode hmmNunitNodede, WordSequence wordSequence, float smearTerm, float smearProb,
            float languageProbability, float insertionProbability, Node parentNode) {
            super(hmmNunitNodede, wordSequence, smearTerm, smearProb);
     ...
     */
    private UnitNode[] getUnitNodes(EndNode endNode) {

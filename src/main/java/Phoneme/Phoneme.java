...
public class Phoneme {
    ...
    public Phoneme(String phoneme, PlaceOfArticfulation phonemeClass, VowelBackness vowelArticulation,
        VowelHeight mouthStatus, VowelBackness vowelArticulation2, VowelHeight mouthStatus2) {
        super();
    ...
    public Phoneme(String phoneme, Excitation pronounciation, PlaceOfArticfulation phonemeClass,
        MannerOfArticulation articulation) {
        super();
        this.phoneme = phoneme;
        this.pronounciation = pronounciation;
        this.phonemeClass = phonemeClass;
